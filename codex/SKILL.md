...
## Running a Task
1. Default to model `gpt-5.4` with reasoning effort `high`. Do NOT ask the user for model or reasoning effort — use these defaults automatically unless the user explicitly specifies otherwise.
